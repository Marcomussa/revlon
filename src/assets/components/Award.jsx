...
import Premio1 from "../img/premio_01.webp"
import Premio2 from "../img/premio_02.webp"
            ...
            <div className="container bg-red-sunset p-xl-5">
                <div className="row px-xl-5 mx-xl-5">
                    <div className="col-12  col-xl-6 mt-4">
                        ...
                        <img className='d-block mx-auto img-size-award pt-4' src={Premio2} alt="Premio2" lazy="loading" />
                        <p className='text-center text-white primary-font text-italic pb-4'>Imagen ilustrativa</p>
                    </div>
                    <div className="col-12 col-xl-6">
                        ...
                        <img className='d-block mx-auto img-size-award pt-4' src={Premio1} alt="Premio1" lazy="loading"/>
                        <p className='text-center text-white primary-font text-italic pb-4'>Imagen ilustrativa</p>
                    </div>
                </div>
            </div>
