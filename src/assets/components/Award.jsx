            ...
            <div className="container bg-red-sunset">
                <div className="row">
                    ...
                    <div className="col-12 col-xl-6">
                        <p className='text-center text-white primary-font text mb-1 pt-xl-5 mt-xl-4 '>El gran premio, ¡donde podrás  llevarte un</p>
                        <h2 className='text-center text-white title primary-font px-5'>VIAJE A CANCUN PARA TI Y UN ACOMPAÑANTE!</h2>
