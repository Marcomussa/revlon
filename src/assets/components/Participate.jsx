            ...
            <div className="container bg-white-waves mt-5">
                <div className="row px-xl-5">
                    <div className="col-12 col-xl-7 p-xl-5">
                        <h1 className='text-center primary-font title-red title-size py-xl-4 mt-xl-5'>¿CÓMO PARTICIPAR?</h1>
                        <p className='text-center text primary-font text-gray px-2 px-xl-4 text-guide'><b>¡Es facilísimo! </b> Adquiere $599 MXN de compra de cualquiera de los productos participantes (puedes consultarlos aquí) ya sea en tiendas fisicas o en linea en los comercios participantes.</p>
                    </div>
                ...
                <div className="row d-flex justify-content-center align-items-center desktop-pd">
                    ...
                    <div className="col-12 col-md-4">
                        <img src={Registro} alt="Registro" className='d-block mx-auto img-size-p' />
                    </div>
