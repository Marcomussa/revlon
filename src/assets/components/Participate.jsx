            ...
            <div className="container bg-white-waves">
                <div className="row mt-5">
                    <div className="col-md-12">
                        <h1 className='text-center fw-bold primary-font title title-red'>¿Cómo participar?</h1>
                        <p className='text-center px-4 text'><b>¡Es facilísimo! Compara productos REVLON participantes por $599 MXN o más:</b> Adquiere cualquiera de los productos participantes, puedes consultarlos aquí, ya sea en tiendas físicas o en línea en los comercios participantes.</p>
                    </div>
                </div>
                <div className="row">
                    {/* Carrousel Inicio*/}
                ...
                <div className="row d-flex justify-content-center">
                    <div className="col-md-12">
                        ...
                        <p className="text-center fw-bold mt-5 primary-font text mb-0">
                        <b>¡1 compra, 1 oportunidad!:</b></p>
                        <p className="text-center fw-bold primary-font text">
                        <b>
                ...
                <div className="row">
                    <div className="col-md-12">
                        <h3 className='text-center fw-bold mt-5 primary-font title-red px-4'>
